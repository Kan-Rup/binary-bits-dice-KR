...
class BinaryDice:
    ...
    #
    #e.g. [ [[1,0,0,1],[1,0,1,5],[0,1,5,6]] , [[0,0,1,4],[1,0,0,1],[0,1,0,2]] ]
    #
    rollsetValuesList = [];
    ...
    def userChoosesAboutInfo(self):
        ...
        print("");
        print("\n\n+++ binary-bits-dice / two methods - (use of 0/1 bits to get the same function as the 6 sided cube dice) +++");
        print("[Version:1]--[Patch:0]--[Label:First release]--[dev:KR]--[Date:15/07/21]");
        print("");
    ...
    def displayHowMethod1Calculated(self):
        ...
        print("values can be : 0 0 , 1 0 , 0 1 , 1 1");
        print("");
        print("first bit : \t0 = decimal 0 ,   1 = decimal 1");
        print("second bit : \t0 = decimal 0 ,   1 = decimal 2");
        print("");
        print("so 0 0 = decimal 0 , 1 0 = decimal 1 , 0 1 = decimal 2, 1 1 = decimal 3 (add the decimal 1 and 2)");
        print("\n");
        ...
        print("1 0  0 0 ---> (decimal-1) + 0 (additon bits) + 1 = decimal 2");
        print("0 1  0 0 ---> (decimal-2) + 0 (additon bits) + 1 = decimal 3");
    ...
    def displayHowMethod2Calculated(self):
        ...
        print("1       0       0   ---->   1   -   -   -   (accepted)");
        print("0       1       0   ---->   2   -   -   -   (accepted)");
        print("1       1       0   ---->   3   -   -   -   (accepted)");
        print("0       0       1   ---->   4   -   -   -   (accepted)");
        print("1       0       1   ---->   5   -   -   -   (accepted)");
        print("0       1       1   ---->   6   -   -   -   (accepted)");
    ...
    def getRollValuesStr(self):
        ...
        if(self.getMethod() == 1):
            ...
            return (" Binary-bit-1:["+str(self.getFP())+"] Binary-bit-2:["+
                    str(self.getSP())+"] Addition-bit-1:["+str(self.getA1())+"] Addition-bit-2:["+str(self.getA2())+"]");

        if(self.getMethod() == 2):

            return (" Binary-bit-1:["+ str(self.getBinaryOne()) +"] Binary-bit-2:["+ 
                    str(self.getBinaryTwo()) +"] Binary-bit-3:["+ str(self.getBinaryThree()) +"]");
    ...
    def doSetRoll(self, amount):
        ...
        #check if method 2 chosen
            ...
            for x in range(amount):
                ...
                n1 = self.getBinaryOne();
                n2 = self.getBinaryTwo();
                n3 = self.getBinaryThree();
